...
(New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/ahmadzahoory/az300template/master/az-300-03-02-c-code.zip", (Get-Location).Path + "\az-300-03-02-c-code.zip")

$zipfile = $shell_app.Namespace((Get-Location).Path + "\az-300-03-02-c-code.zip")
